...
df = pd.read_csv("z_test/school2.csv")
...
df = pd.read_csv("z_test/school1_sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("z_test/school2_sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("z_test/school3_sample.csv")
data = df["Math_score"].tolist()
